    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F5F6F7' }}>
        <Card style={{ width: 420, textAlign: 'center' }}>
          <Alert message="Invalid reset link" description="No token was provided." type="error" showIcon />
        </Card>
      </div>
    );
  }
      ...
      <Card style={{ width: 420, borderRadius: 8 }} styles={{ body: { padding: 40 } }}>
        <Space direction="vertical" size="large" style={{ width: '100%', textAlign: 'center' }}>
          <div>
            ...
            <Title level={3} style={{ marginTop: 12, marginBottom: 4 }}>Reset Password</Title>
          ...
          {success ? (
            <Space direction="vertical">
              <Alert message="Password reset successfully!" type="success" showIcon />
