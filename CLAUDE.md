...
7 August 2026 (superseded file versions and a stored item baseline: migrations 015 and 016, automatic retirement of a replaced predecessor at submission, a reviewer-settable Superseded status, one shared Set status option list across both admin modals, and the company item page's replace link made visible — see `Code/Handover/HANDOVER-CW010-*.md`).
